    ...
    $rootScope.$state = $state;
...
}]).factory('authService', ['$http', '$q', 'localStorageService',  '$rootScope', '$state','$mdToast', function ($http, $q, localStorageService, $rootScope, $state, $mdToast) {
        ...
        var _login = function (loginData) {
           ...
           // var data = "grant_type=password&kullaniciAdi=" + loginData.userName + "&sifre=" + loginData.password;
            ...
            $http.post(api + 'Home/login', data).then(function (response) {
